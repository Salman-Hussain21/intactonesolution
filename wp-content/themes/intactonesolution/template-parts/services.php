        ...
        <div class="row clearfix">
            ...
            <div class="service-block_one col-lg-4 col-md-6 col-sm-12">
                <div class="service-block_one-inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                    ...
                    <h5 class="service-block_one-heading"><a href="#">Website Design and Development</a></h5>
                    <div class="service-block_one-text">Intact One Solution delivers custom, responsive web design and development services that 
optimize user experience and enhance online visibility. We create SEO-friendly websites that 
reflect your brand identity and drive engagement.</div>
            ...
            <div class="service-block_one col-lg-4 col-md-6 col-sm-12">
                <div class="service-block_one-inner wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                    ...
                    <h5 class="service-block_one-heading"><a href="#">Mobile App Development</a></h5>
                    <div class="service-block_one-text">We specialize in iOS, Android, and hybrid mobile app development. Our apps offer intuitive 
user experiences, robust performance, and seamless functionality across all devices.</div>
                    <div class="lower-box d-flex justify-content-between align-items-center flex-wrap">
...
<!-- Service Block One -->
            <div class="service-block_one col-lg-4 col-md-6 col-sm-12">
                <div class="service-block_one-inner wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                    ...
                    <h5 class="service-block_one-heading"><a href="#">Branding & Graphic Design
</a></h5>
                    <div class="service-block_one-text">
			Intact One Solution provides comprehensive branding and graphic design services, including 
brand identity, print design, and marketing materials, to elevate your brand image and drive 
customer engagement.
            ...
            <div class="service-block_one col-lg-4 col-md-6 col-sm-12">
                <div class="service-block_one-inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                    ...
                    <h5 class="service-block_one-heading"><a href="#">SMM (Social Media Marketing)</a></h5>
                    <div class="service-block_one-text">Maximize your online presence with our data-driven social media marketing strategies. We help 
businesses grow through targeted campaigns on Facebook, Instagram, LinkedIn, and more.
</div>
                    <div class="lower-box d-flex justify-content-between align-items-center flex-wrap">
            ...
            <div class="service-block_one col-lg-4 col-md-6 col-sm-12">
                <div class="service-block_one-inner wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                    ...
                    <h5 class="service-block_one-heading"><a href="#">SEO & Content Writing
</a></h5>
                    <div class="service-block_one-text">
oost your online presence with our SEO and content writing services. We offer keywordoptimized content, technical SEO, and link-building strategies that drive organic traffic and 
conversions.
            ...
            <div class="service-block_one col-lg-4 col-md-6 col-sm-12">
                <div class="service-block_one-inner wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                    ...
                    <h5 class="service-block_one-heading"><a href="#">Logo & Illustration
</a></h5>
                    <div class="service-block_one-text">
Our custom logo and illustration services create a memorable visual identity for your brand. We 
design logos and graphics that resonate with your audience and establish brand recognition.


						</div>
                    <div class="lower-box d-flex justify-content-between align-items-center flex-wrap">
                        <div class="service-block_one-number">06</div>
                        <a class="service-block_one-join" href="#">Join now <i class="fa-solid fa-plus fa-fw"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="service-block_one col-lg-4 col-md-6 col-sm-12">
                <div class="service-block_one-inner wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                    ...
                    <h5 class="service-block_one-heading"><a href="#">Animation</a></h5>
                    <div class="service-block_one-text">
Engage your audience with creative animation services, including explainer videos, 2D/3D 
animation, and motion graphics, making your message clear and impactful.

						</div>
                    <div class="lower-box d-flex justify-content-between align-items-center flex-wrap">
                        <div class="service-block_one-number">07</div>
                        <a class="service-block_one-join" href="#">Join now <i class="fa-solid fa-plus fa-fw"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="service-block_one col-lg-4 col-md-6 col-sm-12">
                <div class="service-block_one-inner wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                    ...
                    <h5 class="service-block_one-heading"><a href="#">SaaS Development
</a></h5>
                    <div class="service-block_one-text">
					We develop custom SaaS solutions that streamline business processes and drive scalability. Our 
SaaS services include product design, API development, and consulting tailored to your business 
needs.
