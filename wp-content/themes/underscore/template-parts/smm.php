...
<head>
<meta charset="utf-8">
<title>Social Media Marketing (SMM) - IOS</title>
<!-- Stylesheets -->
	...
	<div class="services-two">
		<div class="auto-container">
			...
			<div class="sec-title style-four centered">
				<div class="sec-title_title">Social Media Marketing (SMM)</div>
				<h2 class="sec-title_heading">Social Media Marketing Strategies for Maximum Reach</h2>
			</div>
			<div class="centered light">
				<p style="color: white;">
In diverse and competitive markets like Pakistan and the Middle East, a strategic 
approach to social media marketing is crucial for business success. Intact One Solution 
develops customized SMM campaigns that increase brand awareness and engagement. From 
crafting eye-catching posts to running optimized ads, we help you grow your online community, 
build customer loyalty, and achieve measurable results
				</p>
				<!-- Service Block Four -->
			</div>
			
						<div class="service-detail_image">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/images/services/smm.svg" alt="" />
			</div>
