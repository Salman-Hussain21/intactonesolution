...
<head>
<meta charset="utf-8">
<title>SEO & Content Writing - IOS</title>
<!-- Stylesheets -->
	...
	<div class="services-two">
		<div class="auto-container">
			...
			<div class="sec-title style-four centered">
				<div class="sec-title_title">SEO & Content Writing</div>
				<h2 class="sec-title_heading">SEO & Content Writing Services to Boost Online Visibility</h2>
			</div>
			<div class="centered light">
				<p style="color: white;">
Enhance your digital presence with SEO and content writing services from Intact 
One Solution. Our content is keyword-optimized and crafted to rank higher on search engines, 
catering to the local markets in Pakistan and the Middle East. From blogs to product 
descriptions, we provide engaging content that not only resonates with your target audience 
but also drives organic traffic, helping you meet your business objectives.
				</p>
				<!-- Service Block Four -->
			</div>
			
						<div class="service-detail_image">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/images/services/seo.svg" alt="" />
			</div>
