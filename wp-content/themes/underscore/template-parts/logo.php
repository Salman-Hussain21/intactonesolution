...
<head>
<meta charset="utf-8">
<title>Logo & Illustration - IOS</title>
<!-- Stylesheets -->
	...
	<div class="services-two">
		<div class="auto-container">
			...
			<div class="sec-title style-four centered">
				<div class="sec-title_title">Logo & Illustration</div>
				<h2 class="sec-title_heading">Unique Logos & Custom Illustrations to Define Your Brand</h2>
			</div>
			<div class="centered light">
				<p style="color: white;">
At Intact One Solution, we specialize in creating custom logos and illustrations
that define your brand’s identity. Whether launching a new business in Pakistan or rebranding 
for the Middle East market, we ensure your brand stands out with a visually striking presence. 
Our designs communicate your brand values and connect emotionally with your audience, 
giving your business a distinct competitive edge.
				</p>
				<!-- Service Block Four -->
			</div>
			
						<div class="service-detail_image">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/images/services/logo.svg" alt="" />
			</div>
