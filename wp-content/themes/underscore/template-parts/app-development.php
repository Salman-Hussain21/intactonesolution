...
<head>
<meta charset="utf-8">
<title>Mobile Application Development - IOS</title>
<!-- Stylesheets -->
	...
	<div class="services-two">
		<div class="auto-container">
			...
			<div class="sec-title style-four centered">
				<div class="sec-title_title">Mobile Application Development</div>
				<h2 class="sec-title_heading">Innovative Mobile Apps for Seamless User Engagement</h2>
			</div>
			<div class="centered light">
				<p style="color: white;">
 In the competitive digital markets of Pakistan and the Middle East, mobile 
applications are essential for customer engagement. Intact One Solution excels in mobile app 
development for both iOS and Android platforms. We create customized mobile apps that 
cater to your business goals, emphasizing user experience with smooth navigation, high 
performance, and seamless interaction. Engage your audience with intuitive and powerful 
mobile applications designed to drive results.
				</p>
				<!-- Service Block Four -->
			</div>
			
						<div class="service-detail_image">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/images/services/mobile-app.svg" alt="" />
			</div>
