...
<head>
<meta charset="utf-8">
<title>Branding & Graphic Design - IOS</title>
<!-- Stylesheets -->
	...
	<div class="services-two">
		<div class="auto-container">
			...
			<div class="sec-title style-four centered">
				<div class="sec-title_title">Branding & Graphic Design</div>
				<h2 class="sec-title_heading">Complete Branding & Graphic Design for a Distinctive Market Presence</h2>
			</div>
			<div class="centered light">
				<p style="color: white;">
Build a lasting impression with branding and graphic design services from Intact 
One Solution. We help businesses in Pakistan and the Middle East create a consistent and 
compelling visual identity across all touchpoints. Whether developing a brand from scratch or 
refreshing an existing one, our expert designers work with you to craft a brand message that 
resonates with your target market and solidifies your market presence
				</p>
				<!-- Service Block Four -->
			</div>
			
						<div class="service-detail_image">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/images/services/graphics.svg" alt="" />
			</div>
