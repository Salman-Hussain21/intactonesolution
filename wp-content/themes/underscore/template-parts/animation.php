	...
	<div class="services-two">
		<div class="auto-container">
			...
			<div class="sec-title style-four centered">
				<div class="sec-title_title">Animation</div>
				<h2 class="sec-title_heading">Engaging Animations to Bring Your Ideas to Life</h2>
			</div>
			<div class="centered light">
				<p style="color: white;">
At Intact One Solution, we produce high-quality animations that captivate 
audiences in Pakistan and the Middle East. From explainer videos to 3D animations, our 
creative team brings your brand's ideas to life through engaging and culturally relevant visual 
stories. Let your brand stand out with custom animation solutions that communicate your 
message clearly and memorably.
				...
				<img src="<?php echo get_template_directory_uri(); ?>/assets/images/services/animation.svg" alt="" />
			</div>
